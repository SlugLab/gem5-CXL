...
"""Bounded schema-2 canonical trace for fixed-20 pull PageRank."""
...
def build_bundle(
    ...
    source_sha256, binary_sha256, config_sha256, graph_scale=14,
...
def build_bundle_from_csr(
    ...
    binary_sha256, config_sha256, graph_scale=14, iterations=20,
):
    ...
    try:
        ...
        raise PageRankTraceError(
            f"G14 graph identity differs: {error}"
        ) from error
    if graph_scale != 14 or observed_graph_sha256 != graph_sha256:
        raise PageRankTraceError("G14 graph identity differs")
