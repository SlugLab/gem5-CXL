    ...
    for latency, base_ticks in LATENCY_BASE_TICKS.items():
        for system, divisor, speedup in (
            ...
            row = {
                ...
                "amu_logical_values": "96" if system == "amu" else "0",
                "amu_line_requests": "32" if system == "amu" else "0",
                "amu_line_cache_hits": "8" if system == "amu" else "0",
                "amu_coalesced_misses": "56" if system == "amu" else "0",
